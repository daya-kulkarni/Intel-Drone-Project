    ...
    for i in range(side_square):
        ...
        for n in range(params.num):
            ...
            try:
                ...
                continue
            w = w_exp * params.anchors[params.anchor_offset + 2 * n] #defines where sizing will occur
...
def main():
    ...
    input_stream = 'udp://0.0.0.0:11111'  if args.input == "cam" else args.input
    ...
    if (args.input != "drone"):
        ...
        while cap.isOpened():
            ...
            if len(objects) and args.raw_output_message:
                ...
                log.infor("YYOLOV3 IS DETECTING CLASS: " + str(det_label)) #last edit
            ...
            for obj in objects:
                ...
                print("YOLOV3 IS DETECTING OBJECT: " + str(coco_labels[int(det_label)])) #last edit
...
#Start the drone flight with takeoff (I'm putting a 3 minute limit before the drone comes down)
            ...
            while(True):
                ...
                def thread1():
                    ...
                    detection_time = float('inf') #Getting around initializing error
                    det_label = 100
                ...
                #Start the drone flight with takeoff (I'm putting a 3 minute limit before the drone comes down)
                        ...
                        print("YOLOV3 IS DETECTING OBJECT: " + str(coco_labels[int(det_label)]))
                        if (int(det_label) == 0):
                            detection_time = time()
                    #if int(det_label) == 80:
                    #    detection_time = time()
        ...
        #person not detected.. classification id 80
                    if int(det_label) == 0 and detect_gate:
                        detection_time = time()
                        tello.rotate_clockwise(90) #Current reaction to seeing a drone
                        detect_gate = False
