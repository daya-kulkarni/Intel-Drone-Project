...
############################################################################
        ...
        while(True):
            ...
            if (time() - takeoff_time) > flight_max:
                print("Max flight time have been logged - triggering autolanding")
                tello.land()
